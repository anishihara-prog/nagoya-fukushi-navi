...
const CHAT_FLOW = [
  ...
  {
    id: "disability",
    botText: "障害の種別・状況を教えてください（複数選択可）。",
    type: "multi",
    options: [
      ...
      { label: "発達障害の疑い(診断なし)", tags: ["発達障害の疑い(診断なし)"] },
      { label: "ひきこもり・不登校", tags: ["ひきこもり・不登校"] },
      { label: "難病",       tags: ["難病"] },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "ひきこもり・不登校のことで相談したい", tags: ["ひきこもり・不登校の相談"], followup: null },
      { label: "介護・高齢期の生活で困っている",       tags: ["介護・高齢期の生活支援"], followup: null },
...
const TAG_GROUPS = {
  disability: {
    label: "障害種別・状況(複数選択可)",
    tags: ["身体障害", "知的障害", "精神障害", "発達障害", "発達障害の疑い(診断なし)", "ひきこもり・不登校", "難病", "重複・不明"],
  },
  age: {
    label: "年代",
  ...
  situation: {
    ...
    tags: [
      ...
      "手帳の取得・更新", "ひきこもり・不登校の相談", "介護・高齢期の生活支援", "緊急時の対応",
    ],
  },
};
